---
title: Text mining, sentiment analysis, and visualization og game of thrones data
date: 27/03-2026
...
Look back at the Game of thones pdf, and search for "confidence." Is it typically associated with emotion, or something else? 
...
Wait, so "stone" is showing up in NRC lexicon as "anger and negative"? Let's check:
```{r nrc-stone}
...
got_top100 <- got_no_numeric %>% 
  ...
  head(100)
got_top100
I can see that the words with a slightly deeper meaning that occur most frequently are “lord” with 1341 occurrences and “Ser” with 1023. Words like these carry a negative connotation, as they refer to people who rule over others and, historically, oppress the peasant class. Therefore, I believe that the text is mostly negatively charged. The word “stone” I consider, like “confidence,” to be an ambiguous word. In everyday language, “stone” would normally not be seen as a negative word or a word that evokes anger.
